      ...
      flex items-center justify-center">
                        ...
                        <div className="w-full h-100">
                            ...
                            <form className="mt-6" action="#" method="POST">
                                <div>
                                    ...
                                    <input type="text" name="" id="" placeholder="Enter Firstname" className="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none" autoFocus required />
                                </div>
                                <div>
                                    <label className="block text-gray-700">Lastname</label>
                                    <input type="text" name="" id="" placeholder="Enter Lastname" className="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none" autoFocus required />
                                </div>
                                <div>
              ...
              focus:bg-white focus:outline-none" required />
                                ...
                                <div className="mt-4">
                                    ...
                                    <input type="password" name="" id="" placeholder="Confirm Password" minLength="6" className="w-full px-4 py-3 mr rounded-lg bg-gray-200 mt-2 border focus:border-blue-500
              focus:bg-white focus:outline-none" required />
                                </div>
