            ...
            <div className='container mx-auto flex flex-wrap py-6'>
                <section className="w-full md:w-2/3 flex flex-col items-center px-3">
                    <article className="flex flex-col shadow my-4">
                        <a href="#" className="text-3xl font-bold hover:text-gray-700 p-2">{event.title}</a>
                        ...
                        <div className="bg-white flex flex-col justify-start px-6">
                            ...
                            <h2 className="text-green-600 text-sm font-bold uppercase px-2 mb-4">Activities</h2>
