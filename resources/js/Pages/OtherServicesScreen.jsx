        ...
        <div>
            ...
            <div>
                ...
                <div className="max-w-xl mx-auto text-center pt-10 md:py-10" >
                    ...
                    <h2 className="font-display font-bold text-3xl md:text-4xl lg:text-5xl">Business Consultation</h2>
                ...
                <div className='w-full'>
                    <div className="container flex flex-col px-6 py-10 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
                        ...
                        <div className="flex items-center justify-center w-full h-96 lg:w-1/2">
                            <img className="object-cover w-full h-full max-w-2xl rounded-md" src="/Images/web/consultation-image.jpg" alt="glasses photo" />
                        </div>
                    </div>
                </div>
