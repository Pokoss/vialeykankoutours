    ...
    return (
        <div className="relative inline-flex">
            ...
            >
                ...
                <span className="ml-2 text-sm font-medium truncate group-hover:text-gray-800">Opoka</span>
            ...
            {/* open dropdown if (dropdown = true) */}
            {
                ...
                <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200">
                  <div className="font-medium text-gray-800">Opoka</div>
                  <div className="text-xs italic text-gray-500">pokoss333@gmail.com</div>
                </div>
                <ul>
                  <li>
                    <Link
