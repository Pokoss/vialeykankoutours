        ...
        <div>
                        ...
                        <div class="flex flex-wrap items-center">
                            ...
                            <div class="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
                                <div class="px-6 py-12 md:px-12">
                                    <h2 class="text-3xl font-bold mb-4 text-primary display-5">Why people trust us</h2>
                                    ...
                                    <div class="grid lg:gap-x-12 md:grid-cols-3">
                                        <div class="mb-12 md:mb-0">
                                            <h2 class="text-3xl font-bold text-primary mb-4">1356</h2>
                                            <h5 class="text-lg font-medium text-gray-500 mb-0">Happy tourists</h5>
                                        </div>

                                        <div class="mb-12 md:mb-0">
                                            <h2 class="text-3xl font-bold text-primary mb-4">62%</h2>
                                            <h5 class="text-lg font-medium text-gray-500 mb-0">Growth</h5>
                                        </div>

                                        <div class="">
                                            <h2 class="text-3xl font-bold text-primary mb-4">93</h2>
                                            <h5 class="text-lg font-medium text-gray-500 mb-0">Tours</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="bg-white">
                <div class="container px-6 py-12 mx-auto">
                    ...
                    <div class="grid grid-cols-1 gap-8 mt-8 lg:mt-8 md:grid-cols-2 xl:grid-cols-3">
                        <div>
                            <div class="inline-block p-3 text-white bg-primary rounded-lg">
            ...
            <div class="bg-gray-100 py-12">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="lg:text-center">
                        <h2 class="text-base text-primary font-semibold tracking-wide uppercase">Location</h2>
